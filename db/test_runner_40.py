...
all 40 questions hardcoded. Writes /tmp/test_results_40.json"""
...
if __name__ == "__main__":
    ...
    for i, q in enumerate(QUESTIONS, 1):
        ...
        open("/tmp/test_results_40.json","w",encoding="utf-8").write(
    ...
    open("/tmp/test_results_40.json","w",encoding="utf-8").write(
        json.dumps(results, ensure_ascii=False, indent=2))
    print("\nfull log saved to /tmp/test_results_40.json")
