...
POLICY = (
    ...
    "5. ПОСЛЕ получения непустого результата SQL — формулируй ОТВЕТ. "
    "Дополнительный запрос делай только если данных явно недостаточно для ответа "
    "(не уточнения, не перепроверки). Лучше дать ответ на основе имеющихся данных, "
    "чем продолжать запросы в поисках идеального."
)
