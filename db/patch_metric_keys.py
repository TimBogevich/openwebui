...
а детализация «в т.ч.» — дочерние строки (item_number вида 6.1.2.x). Чтобы найти
лидера/максимум, бери дочерние строки нужного раздела и сортируй по факт_месяц DESC.
