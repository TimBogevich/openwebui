...
all 40 questions hardcoded. Writes /tmp/test_results_100_guard.json"""
...
# load the 40 questions written to /tmp/questions_100.py
import importlib.util
spec = importlib.util.spec_from_file_location("q", "/tmp/questions_100.py")
...
if __name__ == "__main__":
    ...
    for i, q in enumerate(QUESTIONS, 1):
        ...
        open("/tmp/test_results_100_guard.json","w",encoding="utf-8").write(
    ...
    open("/tmp/test_results_100_guard.json","w",encoding="utf-8").write(
        json.dumps(results, ensure_ascii=False, indent=2))
    print("\nfull log saved to /tmp/test_results_100_guard.json")
