...
ПОЛНОТА ВЫБОРКИ
Если SQL вернул N строк — все N идут в ответ (если число строк ≤ 20). Не сворачивай в «топ-5» и не выбирай произвольную подвыборку, когда запрос уже отфильтровал релевантное. Для сжатия больших списков (>20 строк) — сделай новый SELECT с явным LIMIT и опиши критерий ранжирования."""
